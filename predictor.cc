...
// End Predictor constructor

// Start Get Prediction Method
...
// End Get Prediction method
 
// Start Update Predictor method
void  PREDICTOR::UpdatePredictor(UINT32 PC, bool resolveDir, bool predDir, UINT32 branchTarget){
	...
	if (primeBank < NUMTAGTABLES){
        ...
        &&((tagPred[primeBank][indexTagPred[primeBank]].ctr  == 3) || (tagPred[primeBank][indexTagPred[primeBank]].ctr  == 4))){
